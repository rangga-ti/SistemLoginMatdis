...
<head>
    ...
    <title>Login SistemLoginMatDis</title>
    <style>
...
<body>
    <div class="container">
        ...
        @if (session('status'))
            <div class="error" style="background:#eef2ff; color:#1d4ed8;">{{ session('status') }}</div>
        @endif
        ...
        <p style="text-align:center; margin-top:18px;">
            <a href="{{ route('register') }}" style="color:#2563eb; text-decoration:none;">Belum punya akun? Daftar di sini</a>
        </p>
    </div>
</body>
</html>
