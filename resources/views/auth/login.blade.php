...
<head>
    ...
    <title>Login | Sistem Login MatDis</title>
    ...
    <style>
        ...
        * {
        ...
        /* Wrapper khusus password agar posisi mata konsisten */
        .password-container {
            position: relative;
            display: flex;
            align-items: center;
        ...
        /* Ruang ekstra di kanan input password untuk ikon mata */
        ...
        /* Button Modernization - Khusus untuk Submit */
        button[type="submit"] {
            width: 100%;
            padding: 14px;
            background: #0f172a;
...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="info-panel">
            ...
            <h2>Sistem Validasi Login Modern</h2>
            <p>Implementasi logika matematika, himpunan, dan pohon keputusan dengan autentikasi 4 Role pengguna yang divalidasi menggunakan OTP pada Mailtrap.</p>
        </div>

        <div class="form-panel">
            <h3>Welcome Back</h3>
            <p class="subtitle">Log in untuk mengakses akun Anda</p>
            ...
            <form method="POST" action="{{ route('login.perform') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Contoh: user@mahasiswa.com" required autofocus>
                </div>
