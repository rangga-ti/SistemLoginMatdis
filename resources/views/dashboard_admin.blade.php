...
<body class="bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:text-slate-200 antialiased min-h-screen transition-colors duration-300">
    ...
    <main class="max-w-6xl mx-auto px-6 py-10 space-y-12">
        ...
        <section class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
            <div class="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-red-500/10 to-transparent rounded-bl-full pointer-events-none"></div>
            <div>
                <span class="inline-flex items-center gap-1.5 bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-400 px-3 py-1 rounded-full text-xs font-bold tracking-wider mb-3 uppercase">
                    <span class="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span>
                    ADMIN
                </span>
                <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight">Selamat Datang, {{ $user->name }}!</h1>
                <p class="text-slate-500 dark:text-slate-400 mt-1 text-sm md:text-base">Ini adalah halaman khusus dengan hak akses tertinggi (Administrator).</p>
            </div>
            ...
            <div class="w-full md:w-auto bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 grid grid-cols-1 sm:grid-cols-3 md:flex md:flex-col gap-3 font-mono text-xs text-slate-600 dark:text-slate-400 min-w-[240px]">
                <div><span class="text-slate-400">Badge ID :</span> <span class="text-red-500 dark:text-red-400 font-bold">{{ $user->badge_id }}</span></div>
        ...
        <section class="space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm space-y-4">
                    <h3 class="font-bold text-lg text-slate-800 dark:text-white flex items-center gap-2">
                        <span class="flex items-center justify-center w-6 h-6 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 text-xs font-bold">1</span>
                ...
                <div class="flex flex-col gap-6">
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm flex-1 flex flex-col justify-between">
                        ...
                        <div class="my-4 text-center font-mono text-xl md:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-rose-500">
                            S = A ∧ B ∧ C ∧ D
                        </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm flex-1 flex flex-col justify-between">
                        ...
                        <div class="my-4 text-center font-mono text-xl md:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-red-500">
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-6 border-b border-slate-200 dark:border-slate-800">
                    <h3 class="font-bold text-lg text-slate-800 dark:text-white flex items-center gap-2">
                        <span class="flex items-center justify-center w-6 h-6 rounded-lg bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 text-xs font-bold">3</span>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-sm font-mono">
                            ...
                            <tr class="bg-red-50/30 dark:bg-red-950/20 hover:bg-red-50/50 dark:hover:bg-red-950/30">
            ...
            <div class="bg-[#0F172A] border border-slate-800 rounded-2xl p-6 shadow-xl text-slate-300 font-mono text-xs md:text-sm relative group overflow-hidden">
                <div class="absolute -inset-1 bg-gradient-to-r from-red-500 to-rose-600 rounded-2xl blur opacity-10 pointer-events-none"></div>
                ...
                <div class="overflow-x-auto text-center md:text-left py-4 px-2 bg-slate-950/60 rounded-xl border border-slate-800/80 shadow-inner">
                    <pre class="inline-block text-left leading-relaxed tracking-wide text-rose-300/90 select-none">
